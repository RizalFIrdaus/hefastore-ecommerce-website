    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <figure class="figure">
                    <div class="figure-img">
                        <img src="<?= base_url('assets/') ?>img/feature/3.png" class="figure-img img-fluid">
                        <a href="<?= base_url('') ?>single" class="d-flex justify-content-center">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <figure class="figure">
                    <div class="figure-img">
                        <img src="<?= base_url('assets/') ?>img/feature/1.png" class="figure-img img-fluid">
            ...
            <div class="col-6 col-sm-4 col-md-3 col-lg-2">
                <figure class="figure">
                    <div class="figure-img">
                        <img src="<?= base_url('assets/') ?>img/feature/2.png" class="figure-img img-fluid">
                        <a href="" class="d-flex justify-content-center">
                            <img src="<?= base_url('assets/') ?>img/detail.png" class="align-self-center">
                        </a>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-6 col-sm-3 text-center">
                <figure class="figure">
                    <img src="<?= base_url('assets/') ?>img/designer/1.png" class="figure-img img-fluid">
                    <figcaption class="figure-caption text-center">
                        <h5>Anne Mortgery</h5>
                        <p>Artistic Cloth</p>
                    </figcaption>
