 ...
 <section class="single-product">
     <div class="container">
         <div class="row">
             <div class="col-lg-5">
                 <figure class="figure">
                     <img src="<?= base_url('assets/') ?>img/single/1.png" class="figure-img img-fluid">
                     <figcaption class="figure-caption product-thumbnail-container d-flex justify-content-between">
                         <a href="">
                             <img src="<?= base_url('assets/') ?>img/single/thumbnail/1.png">
                         </a>
                         <a href="">
                             <img src="<?= base_url('assets/') ?>img/single/thumbnail/2.png">
                         </a>
                         <a href="">
                             <img src="<?= base_url('assets/') ?>img/single/thumbnail/3.png">
                         </a>
                         <a href="">
                             <img src="<?= base_url('assets/') ?>img/single/thumbnail/4.png">
                         </a>
                     </figcaption>
                 </figure>
             </div>
                     ...
                     <div class="tab-pane fade product-review" id="review" role="tabpanel" aria-labelledby="review-tab">
                         <div class="row">
                             <div class="col-1 d-none d-md-block">
                                 <img src="<?= base_url('assets/') ?>img/single/review/1.png">
                             </div>
                             <div class="col">
                                 <h5>Joe Mackenzie</h5>
                         ...
                         <div class="row">
                             <div class="col-1 d-none d-md-block">
                                 <img src="<?= base_url('assets/') ?>img/single/review/2.png">
                             </div>
                             <div class="col">
                                 <h5>Brian Smith</h5>
                                 <p>Produknya bagus dan bahannya juga rapih cocok untuk kulit</p>
